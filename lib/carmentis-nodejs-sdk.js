/**
  ...
  Built 2024-05-02T12:46:44.944Z
*/
...
const OFFSET_BODY_HASH      = 53;   // (32 bytes)
const OFFSET_SIGNATURE      = 85;   // (64 bytes)

const BLK_HEADER_SIZE = 149;
...
//  deriveKeyAndId()                                                                                                            //
// ============================================================================================================================ //
async function deriveKeyAndId(seed) {
...
async function generateWordList$1(nWords = MIN_WORDS) {
  ...
  let [ nBytes, seedSize ] = getFormat(nWords);
...
//  deriveFromWordList()                                                                                                        //
// ============================================================================================================================ //
async function deriveFromWordList$1(words) {
  ...
  let [ nBytes, seedSize, hashMask ] = getFormat(words.length),
  ...
  return await deriveKeyAndId(seed);
}

// ============================================================================================================================ //
//  getFormat()                                                                                                                 //
// ============================================================================================================================ //
function getFormat(nWords) {
...
const deriveFromWordList    = userFunction(deriveFromWordList$1);
...
export { MASTER_BLOCK_PERIOD, deriveFromWordList, deriveKeyFromPassword, generateWordList, getChainStatus, getMasterBlock, getMasterBlockList, getMatchingWords, getMicroBlock, getMicroChain };
