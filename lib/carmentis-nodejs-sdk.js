/**
  ...
  Built 2024-08-13T07:27:12.559Z
  --
...
async function queryCarmentisNode$1(nodeUrl, msgId, msgData) {
  ...
  try {
    const a = await thisInterface$2.queryCarmentisNode(nodeUrl + nodePath, data);
    answer = decodeBinary((JSON.parse(a)).result.response.value, BASE64);
  }
  catch(e) {
    console.log("error", e);
...
async function request(arg) {
  ...
  let endpoint = "https://operator.carmentis.local";
...
const ENDPOINT = "https://operator.carmentis.local";
...
export { constants, core, debug, deriveAccountPrivateKey, deriveActorPrivateKey, deriveAesKeyFromPassword, deriveAuthenticationPrivateKey, deriveNodePrivateKey, deriveOrganizationPrivateKey, derivePepperFromSeed, deriveUserPrivateKey, generateWordList, getChainStatus, getFlatRecord, getMasterBlock, getMasterBlockList, getMatchingWords, getMicroBlock, getMicroChain, getPublicKey, getSeedFromWordList, getWordListFromSeed, prepareApproval, processRecord, wallet, web };
