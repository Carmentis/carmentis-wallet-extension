/**
  ...
  Built 2024-09-24T14:00:40.596Z
  --
...
const ENDPOINT$1 = "http://operator.acme.me";
...
async function getDefinition(applicationId, version) {
  const rawDefinition = await getLastSection(OBJ_APPLICATION, applicationId, S_APP_DESCRIPTION);
...
async function processRecord$1(obj, nonce, textCallback, fieldCallback) {
  obj.flowObject.appVersion(nonce);
      let appDef  = (await getDefinition(fromHexa(obj.applicationId))).definition,
