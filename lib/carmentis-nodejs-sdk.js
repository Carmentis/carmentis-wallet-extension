/**
  ...
  Built 2024-09-09T15:30:52.816Z
  --
...
//  create()                                                                                                                    //
// ============================================================================================================================ //
function create$1(keys) {
  return create$3(OBJ_FLOW, populateProperties$1, keys, processSection);
}

// ============================================================================================================================ //
//  load()                                                                                                                      //
// ============================================================================================================================ //
async function load$1(id, keys) {
  return await load$3(OBJ_FLOW, id, populateProperties$1, keys, processSection);
}
...
*/
  obj.flowObject = flowId ? await load$1(flowId, keys) : await create$1(keys);
}
...
// ============================================================================================================================ //
function create() {
  return create$3(OBJ_ORGANIZATION, populateProperties);
}
...
async function load(id) {
  return await load$3(OBJ_ORGANIZATION, id, populateProperties);
}
...
//  getServer()                                                                                                                 //
// ============================================================================================================================ //
async function getServer(organizationId, version) {
  let microChain = await getMicroChain$1(organizationId);
  ...
  let microBlock = await findBlock(microChain, async block => await findSection(block, S_ORG_SERVER, obj => obj.version == version));
...
async function isChanged(org) {
  let [ descChange, serverChange ] = await getChanges(org);
...
//  publish()                                                                                                                   //
// ============================================================================================================================ //
async function publish(org) {
  let [ descChange, serverChange ] = await getChanges(org),
      obj;

  if(org.meta.carmentisId) {
    obj = await load(fromHexa(org.meta.carmentisId));
  }
  else {
    obj = create();
  }
...
async function getChanges(org) {
  ...
  if(org.meta.carmentisId) {
    let previousDesc = await getDescription(fromHexa(org.meta.carmentisId)),
