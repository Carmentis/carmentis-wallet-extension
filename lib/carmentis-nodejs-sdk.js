/**
  ...
  Built 2024-09-04T09:56:27.700Z
  --
...
//  create()                                                                                                                    //
// ============================================================================================================================ //
function create$5(organizationId, qrId, publicKey) {
...
async function request(arg) {
  ...
  let endpoint = "https://testapps.carmentis.io";
...
function qrStatusConnected(elementId) {
  qrSetContent(
    ...
    [
      ...
      create$6("p").style({ fontSize: "48px", margin: 0 }).html(`<i class="bi bi-check-circle-fill"></i>`),
      create$6("p").text("Connected"),
      create$6("p").style({ fontSize: "13px" }).text("Please follow the instructions on your wallet.")
    ]
  );
}
...
function qrStatusExpired(elementId) {
  qrSetContent(
    ...
    [
      // TODO: use a self-contained icon
      create$6("p").style({ fontSize: "48px", margin: 0 }).html(`<i class="bi bi-arrow-clockwise"></i>`),
      create$6("p").text("Expired"),
      create$6("p").text("(Click to refresh)")
    ],
    refresh
  );
...
function setQRCode(elementId, organizationId, qrId, publicKey) {
  let [ qrImgTag, qrData ] = create$5(organizationId, qrId, publicKey);
...
async function createGenesis(objectType) {
  return await create$4(true, objectType);
}
...
async function createNext(objectType) {
  return await create$4(false, objectType);
}
...
// ============================================================================================================================ //
async function create$4(isGenesis, objectType) {
  let block = {
    isGenesis: isGenesis,
    sections : [],
    dataSize : 0,
...
//  load()                                                                                                                      //
// ============================================================================================================================ //
async function load$3(id, microBlockList) {
...
//  create()                                                                                                                    //
// ============================================================================================================================ //
function create$2(type, objectCallback, keyring, sectionCallback) {
  let chain = create$3(type);
...
//  load()                                                                                                                      //
// ============================================================================================================================ //
async function load$2(type, chainId, objectCallback, keyring, sectionCallback) {
...
// ============================================================================================================================ //
function create$1() {
  return create$2(OBJ_APPLICATION, populateProperties$1);
}
...
async function load$1(id) {
  return await load$2(OBJ_APPLICATION, id, populateProperties$1);
}
...
function create(keys) {
  return create$2(OBJ_FLOW, populateProperties, keys, processSection);
}
...
async function load(id, keys) {
  return await load$2(OBJ_FLOW, id, populateProperties, keys, processSection);
}
...
const deployApplication  = userFunction(deploy);
...
export { applicationChanged, constants, core, dataServerQuery, deployApplication, deriveAccountPrivateKey, deriveActorPrivateKey, deriveAesKeyFromBits, deriveAesKeyFromPassword, deriveAuthenticationPrivateKey, deriveNodePrivateKey, deriveOrganizationPrivateKey, derivePepperFromSeed, deriveUserPrivateKey, generateWordList, getChainStatus, getFlatRecord, getMasterBlock, getMasterBlockList, getMatchingWords, getMicroBlock, getMicroChain, getPublicKey, getSeedFromWordList, getWordListFromSeed, prepareApproval, processRecord, registerDataEndpoint, registerNodeEndpoint, wallet, web };
